        ...
        >
          ...
          <div className="glass absolute inset-0 flex items-center justify-center rounded-2xl [backface-visibility:hidden]">
            <span
              ...
              style={{ color: gradientColor(index / 17) }}
            >
              {index + 1}
            </span>
            <motion.span
          ...
          <div
            ...
            style={{
              background: `linear-gradient(135deg, ${gradientColor(index / 17)}15, ${gradientColor(index / 17)}05)`,
              border: `1px solid ${gradientColor(index / 17)}30`,
              boxShadow: flipped ? `0 0 30px -10px ${gradientColor(index / 17)}40` : undefined,
            }}
          >
            <span
...
export default function EighteenV2() {
